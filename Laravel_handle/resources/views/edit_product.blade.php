            ...
            <div class="col-md-4 offset-4 rounded bg-info mt-3 py-3">
                ...
                <form class="mt-3" action="{{ route('update_product', ['product' => $product->id, 'user' => $user->id]) }}" method="POST">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control" class="invalid-feedback" name="image" placeholder="Masukkan gambar produk"
                            value="{{ $product->image }}">
                    </div>
                    <div class="mb-1">
                        <label for="exampleFormControlInput1" class="form-label fw-semibold">Nama Produk</label>
                        <input type="text" class="form-control" class="invalid-feedback" name="nama"
                    ...
                    <div class="mb-1">
                        ...
                        <input type="number" class="form-control" class="invalid-feedback" name="berat"
                    ...
                    <div class="mb-1">
                        ...
                        <input type="number" class="form-control" class="invalid-feedback" name="harga"
                    ...
                    <div class="mb-1">
                        ...
                        <input type="number" class="form-control" class="invalid-feedback" name="stok"
                    ...
                    <div class="mb-1">
                        ...
                        <select class="form-select form-control" class="invalid-feedback" aria-label="Default select example" name="kondisi">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" class="invalid-feedback" name="deskripsi" id="exampleFormControlTextarea1" rows="3"
